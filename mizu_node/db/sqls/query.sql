...
CREATE INDEX idx_queries_user_dataset_id_status ON queries(user_id, dataset_id, status);
CREATE INDEX idx_queries_user_created_at ON queries(user_id, created_at);
